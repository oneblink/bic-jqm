...
if(empty($config['characterEncoding']))
    header('Content-Type: text/html');
else
    header('Content-Type: text/html;charset=' . $config['characterEncoding']);

//session_cache_limiter('nocache');

if (!empty($answerSpace['timezone'])) {
	date_default_timezone_set($answerSpace['timezone']);
}
